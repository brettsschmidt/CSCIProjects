...
public class LoginUI extends JFrame implements ActionListener, WindowListener
	{
		...
		public JPanel getContentPane()
		{
			if( contentPane == null )
			{
				...
				JMenuBar login2Bar = new JMenuBar();
				JMenuBar loginBar = new JMenuBar();
				bannerBar.setLayout(new FlowLayout(FlowLayout.CENTER));
				userBar.setLayout(new GridLayout(2,1));
				PWBar.setLayout(new GridLayout(2,1));
				login2Bar.setLayout(new GridLayout(1,2));
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			switch( e.getActionCommand() )
			{
				...
				case "LOGIN":
					...
					Boolean logged = WorkoutDB.Login(UserName, PW).Logged();
					
					if(logged == true)
					{
					CSCI239_PTProject.MasterUI = new CSCI239_UI();
